...
function App() {
  ...
  const getRandomCharacter = useCallback(async () => {
    ...
    const res = await axios.get(`https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=${randomLetter}&limit=100&apikey=c70bee055661b1eabc28f40a0fea1796&hash=1fb53ea11fb2c416560dbeccb40e01fc`)
