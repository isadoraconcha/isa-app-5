...
function App() {
  ...
  const getCharacter = useCallback(async (id) => {
    const res = await axios
      .get(
        `https://gateway.marvel.com:443/v1/public/characters/${id}?ts=1&apikey=9ab3f4223305129d78c4e31277c69318`
      )
  ...
  const getRandomCharacter = useCallback(async () => {
    ...
    const res = await axios.get(`https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=${randomLetter}&limit=100&apikey=c70bee055661b1eabc28f40a0fea1796`)
