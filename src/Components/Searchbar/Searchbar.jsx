...
export const SearchBar = ({ onCharactersChange }) => {
  ...
  const onSearch = useCallback(async () => {
    ...
    let url;
    if (searchBy === 'name') {
      url = `https://gateway.marvel.com:443/v1/public/characters?ts=1&nameStartsWith=${query}&limit=10&apikey=9ab3f4223305129d78c4e31277c69318&hash=1fb53ea11fb2c416560dbeccb40e01fc`;
    } else if (searchBy === 'comic') {
      url = `https://gateway.marvel.com:443/v1/public/characters?ts=1&comics=${query}&limit=10&apikey=9ab3f4223305129d78c4e31277c69318&hash=1fb53ea11fb2c416560dbeccb40e01fc`;
    } else {
      url = `https://gateway.marvel.com:443/v1/public/characters?ts=1&nameStartsWith=${query}&limit=10&apikey=9ab3f4223305129d78c4e31277c69318&hash=1fb53ea11fb2c416560dbeccb40e01fc`;
    }
